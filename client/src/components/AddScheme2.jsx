...
const AddScheme2 = ({ onNext }) => {
    const [formData, setFormData] = useState({
        ...
        currentStep: "", // Temporary step for dynamic input
    });
    ...
    const handleTagRemove = (tag) => {
        setFormData({
            ...formData,
            selectedTagDocuments: formData.selectedTagDocuments.filter((doc) => doc !== tag),
        });
    };
                ...
                <form id="schemeForm" className="schemeForm" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            onKeyDown={handleKeyDown}  // Detect keypress
                        />
                        <div className="mt-2">
                            {formData.selectedTagDocuments.map((tag) => (
                                <span
                                    key={tag}
                    ...
                    {/* Benefits Section */}
                    <div className="mb-4">
                        <label htmlFor="benefits" className="block text-sm font-semibold mb-2">
                    ...
                    <div className="mb-4">
                        <label htmlFor="stepsForApplying" className="block text-sm font-semibold mb-2">
                            Steps for Applying
                        </label>
                        <div className="flex">
                            <input
